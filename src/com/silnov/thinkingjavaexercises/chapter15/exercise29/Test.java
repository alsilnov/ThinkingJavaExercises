package com.silnov.thinkingjavaexercises.chapter15.exercise29;
...
public class Test {
    ...
    static void f2(List<Holder<?>> list) {
        ...
        System.out.println(list.get(0).getClass() + ": " + list.get(0).get().getClass().getSimpleName() + ", "
                + list.get(0).get());
        System.out.println(list.get(1).getClass() + ": " + list.get(1).get().getClass().getSimpleName() + ", "
                + list.get(1).get());
        System.out.println(list.get(2).getClass() + ": " + list.get(2).get().getClass().getSimpleName() + ", "
                + list.get(2).get());
