package com.silnov.thinkingjavaexercises.chapter15.exercise36;
...
class ProcessRunner<T, E extends Exception, E2 extends Exception> extends ArrayList<Processor<T, E, E2>> {
...
public class Test {
    public static void main(String[] args) {
        ...
        ProcessRunner<String, Failure1, Failure3> runnerb = new ProcessRunner<String, Failure1, Failure3>();
        for (int i = 0; i < 3; i++)
        ...
        ProcessRunner<Integer, Failure2, Failure3> runner2b = new ProcessRunner<Integer, Failure2, Failure3>();
        for (int i = 0; i < 3; i++)
