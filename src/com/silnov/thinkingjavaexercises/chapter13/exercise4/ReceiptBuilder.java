...
public class ReceiptBuilder {
    ...
    public ReceiptBuilder() {
        f.format(formatTitle, "Item", "Qty", "Price");
    ...
    public String build() {
        f.format(formatTaxAndTotal, "Tax", "", total * 0.06);
        f.format(formatTitle, "", "", "-----");
        f.format(formatTaxAndTotal, "Total", "", total * 1.06);
        return f.toString();
    }
 ...
 * 5.10 Three Bears Por 1 14.29 Tax 2.80 ----- Total 49.39
 */